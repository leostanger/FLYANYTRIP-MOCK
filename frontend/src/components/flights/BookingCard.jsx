...
export default function BookingCard({ activeTab = 'flights', setActiveTab }) {
  ...
  const [checkInDate, setCheckInDate] = useState(defaultDepDate)
  const [checkOutDate, setCheckOutDate] = useState(defaultRetDate)
  ...
  const [holidayStartDate, setHolidayStartDate] = useState(defaultDepDate)
  const [holidayEndDate, setHolidayEndDate] = useState(defaultRetDate)
